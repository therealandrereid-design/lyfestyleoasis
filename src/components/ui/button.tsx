...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_4px_30px_hsl(38_70%_50%_/_0.15)] hover:shadow-[0_0_60px_hsl(38_70%_50%_/_0.2)]",
        destructive:
        ...
        gold: "bg-gradient-to-br from-[hsl(38,80%,45%)] to-[hsl(38,60%,55%)] text-[hsl(0,0%,5%)] font-semibold hover:opacity-90 shadow-[0_4px_30px_hsl(38_70%_50%_/_0.15)] hover:shadow-[0_0_60px_hsl(38_70%_50%_/_0.2)]",
        whatsapp: "bg-[#25D366] text-white hover:bg-[#20BD5A] shadow-lg hover:shadow-xl",
        glass: "bg-[hsl(0,0%,8%,0.8)] backdrop-blur-[12px] border border-[hsl(0,0%,15%,0.5)] text-foreground hover:bg-[hsl(0,0%,12%,0.6)]",
      },
      size: {
